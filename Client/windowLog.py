...
class LogWindow(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.logo.setPixmap(QPixmap(u"img\\big.png"))
    ...
    def completeUi(self):
        ...
        self.setWindowTitle(QCoreApplication.translate("self", u"SDChat", None))
        ...
        self.titulo.setText(QCoreApplication.translate("self", u"SDChat", None))
        self.logo.setText("")

        # Place Holders dos campos
        self.username.setPlaceholderText(QCoreApplication.translate("self", u"Maria", None))
