...
class MainWindow(QMainWindow):
	...
	def setupUi(self):
		...
		# WINDOW
		self.setWindowIcon(QtGui.QIcon(u"img\\mini.png"))
		...
		self.logo.setText("")
		self.logo.setPixmap(QtGui.QPixmap(u"img\\big.png"))
		self.logo.setAlignment(QtCore.Qt.AlignCenter)
		self.logo.setScaledContents(True)
		self.logo.setWordWrap(False)
		self.logo.setIndent(-2)
		self.logo.setObjectName("big")
	...
	def translateUi(self):
		...
		self.setWindowTitle(_translate("MainWindow", "SDChat"))
	...
	def changeNameWin(self):
		...
		self.nameWin.setWindowIcon(QtGui.QIcon(u"img\\mini.png"))
	...
	def sobreWin(self):
		...
		self.sobreWin.setWindowIcon(QtGui.QIcon(u"img\\mini.png"))
		...
		self.label.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(255, 255, 255, 0));\n"
		"color: rgb(255, 255, 255);")
		self.label.setText(u"<html><head/><body><p align=\"center\">Projeto desenvolvido para disciplina<br/> de sistema distribuído</p><p align=\"center\"><br/></p><p align=\"center\"></p><p align=\"center\"><br/><br/></p><p align=\"center\">2023</p><p align=\"center\"></p></body></html>")
